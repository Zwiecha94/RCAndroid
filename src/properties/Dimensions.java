...
public class Dimensions {
	...
	private void calculateI2andS2WhenXtheHighest(double alfaE, double aS1, double aS2) {
		...
		i2 = b*Math.pow(x2, 3)/12 + b*x2*Math.pow((x2/2),2) + 
				(bEff-b)*Math.pow(hf, 3)/12 + (bEff - b)*hf*Math.pow((x2-hf/2),2) + 
	...
	public void calculateX2AndS2AndI2(double alfaE, double aS1, double aS2) {
		...
		if (x2<=hf) {
			...
			double a2 = b/2;
			double b2 = (bEff-b)*hf + alfaE*aS2 + alfaE*aS1;
			double c2 = -(bEff-b)*hf*hf/2 - alfaE*aS2*a2 - alfaE*aS1*d;
			...
			if (x2>hf && x2<(h-hft)) {
				...
				double b3 = (bEff-b)*hf + (-2*h+ 2*hft)*(befft-b)/2 + alfaE*aS2 + alfaE*aS1;
				double c3 = -(bEff-b)*hf*hf/2 + (-2*h*hft+h*h+hft*hft)*(befft-b)/2 - alfaE*aS2*a2 - alfaE*aS1*d;
	...
	public void calculateI1(double alfaE, double aS1, double aS2) {
		i1 = b*Math.pow(h, 3)/12 + b*h*Math.pow((h/2-x1),2) + 
				(bEff-b)*Math.pow(hf, 3)/12 + (bEff-b)*hf*Math.pow((x1-hf/2), 2) + 
	...
	public void calculateAC1(double alfaE, double aS1, double aS2) {
		aC1 = (bEff-b)*hf + (befft-b)*hft + b*h + alfaE*aS2 + alfaE*aS1;
	...
	public void calculateInitialS1(double alfaE, double aS1, double aS2) {
		s1 = (bEff-b)*hf*hf/2 + (befft-b)*hft*(h-hft/2) + b*h*h/2 + alfaE*aS2*a2 + alfaE*aS1*d;
	...
	public void calculateS1C(double alfaE, double aS1, double aS2) {
		s1C = (bEff-b)*hf*hf/2 + (befft-b)*hft*(h-hft/2) + b*h*h/2 + alfaE*aS2*a2 + alfaE*aS1*d;
	...
	public void calculateIc() {
		iC = b * Math.pow(h, 3) / 12 + b * h * Math.pow((0.5 * h - xC), 2) + 
				(bEff - b) * Math.pow(hf, 3)/ 12 + (bEff - b) * hf * Math.pow((xC - 0.5 * hf), 2) + 
	...
	public void calculateSc() {
		sC = 0.5 * b * h * h + 0.5 * (bEff - b) * hf * hf + 0.5 * (befft - b) * hft * hft;
	...
	public void calculateU() {
		u = 2*(h-hf-hft) + 2*hft + befft + (befft-b) + (bEff-b);
